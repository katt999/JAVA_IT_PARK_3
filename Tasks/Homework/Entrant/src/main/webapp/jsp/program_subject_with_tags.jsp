...
<table style="width: 50%; font-family: 'Open Sans', sans-serif;paddi">
  ...
  <c:forEach items="${programSubjects}" var="programSubject">
    <tr>
      <td>${programSubject.id}</td>
      <td>${programSubject.code}</td>
      <td>${programSubject.title}</td>
    </tr>
  </c:forEach>
</table>
<form action="/program_subject_as_jsp" method="post" class="wpcf7">
  <input type="text" style="width:250px;" name="code" placeholder="Код" class="wpcf7-form-control">
