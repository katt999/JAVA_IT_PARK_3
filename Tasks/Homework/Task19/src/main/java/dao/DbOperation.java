...
public class DbOperation{
    ...
    public static void  showOwner(int id) throws SQLException, ClassNotFoundException {
        Connection connection = connectSql();
        PreparedStatement preparedStatement = connection
    ...
    public static void  showCar(int id) throws SQLException, ClassNotFoundException {
        Connection connection = connectSql();
        PreparedStatement preparedStatement = connection
